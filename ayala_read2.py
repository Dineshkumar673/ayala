...
import os
path = '/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/segmented_dataset/Ayala_augs_0003/'
...
for i in range (0,len(directory_contents)):
    ...
    for j in range (0,len(class_name)):
        ...
        for k in range (0,len(img_name)):
            ...
            #print(input_frame)
            with mp_pose.Pose(static_image_mode=True,min_detection_confidence=0.37,model_complexity=1) as pose:
