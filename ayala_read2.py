...
import os
path = '/mnt/fs/Synthetic_dataset_creation/Absdiff_dataset/Datasets/Absdiff_base_dir/segmented_dataset/Ayala_augs_0002/'
...
for i in range (0,len(directory_contents)):
    ...
    for j in range (0,len(class_name)):
        ...
        for k in range (0,len(img_name)):
            ...
            #print(input_frame)
            with mp_pose.Pose(static_image_mode=True,min_detection_confidence=0.4,model_complexity=0) as pose:
        ...
        with open(r'/mnt/fs/ayala/ayala2.csv', 'a',newline='') as f:
